...
2. **网页快照/存证**  
   - 利用第三方网页快照服务（如[网页时光机](https://web.archive.org/)、[中国互联网公证处](https://www.webnotar.com/)、[存证云](https://www.cunzhengyun.cn/)等）保存被抄袭页面的快照，防止对方删除或篡改内容。
   - 也可用平台自带的“举报”或“侵权投诉”功能上传快照或存证材料。
